...
// X Layer Mainnet USDT default address (can be overridden by USDT_ADDRESS env)
const DEFAULT_USDT_ADDRESS = "0x779ded0c9e1022225f8e0630b35a9b54be713736";
const USDT_ADDRESS = process.env.USDT_ADDRESS || DEFAULT_USDT_ADDRESS;
const SEMAPHORE_ADDRESS_BY_NETWORK = {
  xlayer: "0xa83F84B63ebAaCe25456f78aC624BD7Be35B2154",
  xlayer_testnet: "0x9c04BEb93d3c84f94A89e4102a24475e29084dBE",
};
...
async function main() {
  ...
  console.log("Deploying VeriEscrow with:", deployer.address);
  ...
  const VeriEscrow = await hre.ethers.getContractFactory("VeriEscrow");
  const escrow = await VeriEscrow.deploy(USDT_ADDRESS, registryAddress, semaphoreAddress, sbtAddress);
  await escrow.waitForDeployment();

  const escrowAddress = await escrow.getAddress();
  console.log("VeriEscrow deployed to:", escrowAddress);
